        ...
        while True:
            ...
            if data:
                ...
                if pack.is_crc_valid(stream):
                    ...
                    #print(c.charger_attributes())
                    update_variable_values()
                    #flag_dict = c.translate_Charger_status()
                    app.update()
    except Exception as e:
        print(e)
